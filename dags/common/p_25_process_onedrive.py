...
@task_group(
    group_id="onedrive",
    tooltip="This task group is use for One Drive",
    prefix_group_id=True,
)
def process_onedrive():

    # TODO: Start checking JDBC connection for OneDrive.
    check_conn = EmptyOperator(task_id="trigger-process-onedrive")
    ...
    def switch_file_format(**context):
        ...
        return [f"onedrive.trigger_file_{file_format.lower()}"]
